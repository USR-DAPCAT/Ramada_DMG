...
generacio_num_episodi_index<-function() {
  ...
  # Open analitiques 
  # fitxer_text<-"EPIDMGCAT_entregable_variables_analitiques_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_analitiques_20211124_123210.rds"
  
  dt_analitiques<-
    readRDS(here::here(directori_dades_origen,fitxer_text)) %>% 
...
generacio_historic_tabac<-function(cataleg=dt_cataleg) {
  ...
  # fitxer_text<-"EPIDMGCAT_entregable_variables_assir_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_assir_20211124_123210.rds"
  
  dt<-readRDS(here::here(directori_dades_origen,fitxer_text)) 
...
agregacio_diagnostics<-function(dt_index=dt_index,dt_cataleg=dt_cataleg) {
  ...
  # fitxer_text<-"EPIDMGCAT_entregable_cmbdh_diagnostics_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_cmbdh_diagnostics_20211124_123210.rds"
  dt_diagnostics_HOSP<-readRDS(here::here(directori_dades_origen,fitxer_text )) 
  #v)
  
  # fitxer_text<-"EPIDMGCAT_entregable_diagnostics_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_diagnostics_20211124_123210.rds"
  dt_diagnostics_AP<-readRDS(here::here(directori_dades_origen,fitxer_text)) 
...
agregacio_analitiques<-function(dt_tabac,dt_index) {
  ...
  # fitxer_text<-"EPIDMGCAT_entregable_variables_analitiques_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_analitiques_20211124_123210.rds"
  dt_analitiques<-readRDS(here::here(directori_dades_origen,fitxer_text)) 
  
  # fitxer_text<-"EPIDMGCAT_entregable_variables_cliniques_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_cliniques_20211124_123210.rds"
  dt_cliniques<-readRDS(here::here(directori_dades_origen,fitxer_text )) 
...
agregacio_facturacio<-function(dt_index=dt_index,dt_cataleg=dt_cataleg) {
  ...
  # directori_dades_origen<-"../DADES/epiDMGCAT/SIDIAP"
  # fitxer_text<-"EPIDMGCAT_entregable_farmacs_facturats_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_farmacs_facturats_20211124_123210.rds"
  dt_farmacs_facturats<-readRDS(here::here(directori_dades_origen,fitxer_text)) %>% select(-agr)
...
agregacio_prescripcio<-function(dt_index=dt_index,dt_cataleg=dt_cataleg) {
  ...
  # fitxer_text<-"EPIDMGCAT_entregable_farmacs_prescrits_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_farmacs_prescrits_20211124_123210.rds"
  dt_farmacs_prescrits<-readRDS(here::here(directori_dades_origen,fitxer_text)) %>% select(-agr)
...
vinculacio_dades_agregades<-function(dt_index,dt_DMGgrup,dtagr_analitiques,dtagr_diagnostic,
  ...
  # fitxer_text<-"EPIDMGCAT_entregable_variables_geosanitaries_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_geosanitaries_20211124_123210.rds"
  dt_geosanitaries<-readRDS(here::here(directori_dades_origen,fitxer_text)) 
  
  # fitxer_text<-"EPIDMGCAT_entregable_variables_socioeconomiques_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_variables_socioeconomiques_20211124_123210.rds"
  dt_socioeconomiques<-readRDS(here::here(directori_dades_origen,fitxer_text)) 
  
  # fitxer_text<-"EPIDMGCAT_entregable_poblacio_20210222_142117.rds"
  fitxer_text<-"EPIDMGCAT_entregable_poblacio_20211124_123210.rds"
  dt_poblacio<-readRDS(here::here(directori_dades_origen,fitxer_text))
